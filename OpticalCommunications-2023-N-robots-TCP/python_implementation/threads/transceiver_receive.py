...
def transceiver_receive(serial_port):
    ...
    while True: 
        ...
        if globals.debug_transceiver_receive: print("Put packet in data received queue. Queue size: " + str(globals.data_received.qsize()) + " Queue Empty? " + str(globals.data_received.empty()))
